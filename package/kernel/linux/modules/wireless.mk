...
define KernelPackage/rtl8188cus_ap
  SUBMENU:=$(WIRELESS_MENU)
  TITLE:=pcDuino V2/V3 wifi driver
  DEPENDS:=@USB_SUPPORT 
  KCONFIG:=CONFIG_RTL8192CU
  FILES:=$(LINUX_DIR)/drivers/net/wireless/rtl8192cus/8192cu.ko
  AUTOLOAD:=$(call AutoProbe,rtl8188cus_ap)
endef

define KernelPackage/rtl8188cus_ap/description
 Kernel support for pcDuino V2/V3 wifi
endef

$(eval $(call KernelPackage,rtl8188cus_ap))
